...
~~~sh
git clone git@github.com:nko3/top-gan.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-top-gan --password 43Tw/hWEfErJjew0
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/top-gan" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280709
[3]: https://github.com/nko3/top-gan
